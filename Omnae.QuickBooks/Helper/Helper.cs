...
namespace Omnae.QuickBooks
{
    public class Helper
    {
        public static T Add<T>(ServiceContext context, T entity) where T : IEntity
        {
        ...
        public static List<T> FindAll<T>(ServiceContext context, T entity, int startPosition = 1, int maxResults = 100) where T : IEntity
        {
            DataService service = new DataService(context);
        ...
        public static T FindById<T>(ServiceContext context, T entity) where T : IEntity
        {
            DataService service = new DataService(context);
        ...
        public static T Update<T>(ServiceContext context, T entity) where T : IEntity
        {
            //initializing the dataservice object with servicecontext
            DataService service = new DataService(context);
        ...
        public static T SparseUpdate<T>(ServiceContext context, T entity) where T : IEntity
        {
            //initializing the dataservice object with servicecontext
            DataService service = new DataService(context);
        ...
        public static T Delete<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static T Void<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static List<T> CDC<T>(ServiceContext context, T entity, DateTime changedSince) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static Attachable Upload(ServiceContext context, Attachable attachable, System.IO.Stream stream)
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static byte[] Download(ServiceContext context, Attachable entity)
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static ReadOnlyCollection<IntuitBatchResponse> Batch<T>(ServiceContext context, Dictionary<OperationEnum, object> operationDictionary) where T : IEntity
        {
            DataService service = new DataService(context);
        ...
        public static Report GetReportAsync(ServiceContext context, string reportName)
        {
            //Initializing the Dataservice object with ServiceContext
        ...
        public static List<T> FindAllAsync<T>(ServiceContext context, T entity, int startPosition = 1, int maxResults = 500) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static T FindByIdAsync<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static T UpdateAsync<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static T DeleteAsync<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static void VoidAsync<T>(ServiceContext context, T entity) where T : IEntity
        {
            //Initializing the Dataservice object with ServiceContext
            DataService service = new DataService(context);
        ...
        public static T FindOrAdd<T>(ServiceContext context, T entity) where T : IEntity
        {
        ...
        public static Account FindOrAddAccount(ServiceContext context, AccountTypeEnum accountType, AccountClassificationEnum classification)
        {
        ...
        public static Purchase FindOrAddPurchase(ServiceContext context, PaymentTypeEnum paymentType)
        {
        ...
        public static PaymentMethod FindOrAddPaymentMethod(ServiceContext context, string paymentType)
        {
        ...
        public static Item FindOrAddItem(ServiceContext context, ItemTypeEnum type)
        {
