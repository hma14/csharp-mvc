...
namespace Omnae.BackgroundWorkers.Auth0
{
    static class Auth0Token
    {
        ...
        {
            var client_id = CloudConfigurationManager.GetSetting("auth0_client_id");
            var client_secret = CloudConfigurationManager.GetSetting("auth0_client_secret");
            var auth0_base = CloudConfigurationManager.GetSetting("auth0_base");
